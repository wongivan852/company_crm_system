...
class CustomerAdmin(admin.ModelAdmin):
    list_display = [
        'full_name', 'email', 'customer_type', 'status', 
        'preferred_communication', 'marketing_consent', 'created_at'
    ]
    list_filter = [
        'customer_type', 'status', 'preferred_communication', 
    ...
    fieldsets = (
        ...
        ('Communication', {
            'fields': ('whatsapp_number', 'wechat_id', 'preferred_communication', 'marketing_consent')
        }),
        ('Professional Information', {
            'fields': ('customer_type', 'status', 'company', 'position')
        }),
