# Generated by Django 4.2.16 on 2026-01-07 07:23
...
class Migration(migrations.Migration):
    dependencies = [
        ("crm", "0002_add_activity_and_stripe_models"),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="customer",
            index=models.Index(
                fields=["customer_centre"], name="crm_custome_custome_b263f1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customer",
            index=models.Index(
                fields=["service_subscribed"], name="crm_custome_service_ae5564_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customer",
            index=models.Index(
                ...
                name="crm_custome_custome_804c3f_idx",
            ),
        ),
    ]
